...
const handleSubmit= async(e:React.FormEvent<HTMLFormElement>)=>{
 ...
 try {
  ...
  <Box width={"100%"} height={"100%"} display="flex" flex={1}>
    ...
    <Box display={"flex"} flex={{xs:1 , md:0.5}} justifyContent={"center"} alignItems={"center"} padding={5} ml={"auto"} mt={16}>  
...
/*<Box display={"flex"} flex={{xs:1 , md:0.5}} justifyContent={"center"} alignItems={"center"} padding={2} ml={"auto"} mt={16}>
      ...
      <Typography  variant="h4" textAlign={"center"} padding={200} fontWeight={600}> 
        Login
      </Typography>
