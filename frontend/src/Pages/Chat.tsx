...
<Typography sx={{mx:"auto",fontFamily:"work sans",my:4,p:3}}>
  You can ask questions related to Knowldege , Buisness , Advices , Education , etc . But avoid sharing personal information.
</Typography>
...
<Typography sx={{   fontSize:"38px",color:"white",mb:2 , mx:"auto"}}>
  Model - GPT 3.5 Turbo
</Typography>
...
<div style={{ width :"100%", padding:"20px", borderRadius:8,backgroundColor:"rgb(17,27,29)" , display:"flex", margin:"auto" ,}}>
{" "}
<input  ref={inputRef}
